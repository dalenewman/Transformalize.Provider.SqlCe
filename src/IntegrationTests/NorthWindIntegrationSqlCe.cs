...
namespace IntegrationTests {
    ...
    public class NorthWindIntegrationSqlCe {
        ...
        public string TestFileInit { get; set; } = @"Files\NorthWindSqlServerToSqlCeInit.xml";
        ...
        public void SqlCe_Integration() {
            ...
            // RUN INIT AND TEST
            using (var outer = new ConfigurationContainer(new CSharpModule()).CreateScope(TestFileInit)) {
                using (var inner = new TestContainer(new CSharpModule(), new SqlServerModule(), new SqlCeModule()).CreateScope(outer, new ConsoleLogger(LogLevel.Debug))) {
